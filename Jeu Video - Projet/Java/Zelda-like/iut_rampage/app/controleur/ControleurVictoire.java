...
public class ControleurVictoire implements Initializable{
	...
	private int temps;
	Image gif1=new Image("Images/gifV1.gif");
	Image gif2=new Image("Images/gifV2.gif");
	private Timeline winLoop;
	...
	public void winLoop() {
		winLoop = new Timeline();
		temps=0;
		winLoop.setCycleCount(Timeline.INDEFINITE);
